...
exports.Game = exports.Player = exports.Deck = undefined;
...
var Deck = exports.Deck = function () {
    ...
    _createClass(Deck, [{
        ...
        value: function draw() {
            ...
            var drawnCards = [];
            _.each(_.range(n), function (count) {
                var topCard = _this2.cards.pop();
                drawnCards.push(topCard);
                _this2.cardsInPlay.push(topCard);
            });
            return drawnCards;
        }
    }, {
        ...
        value: function collect() {
            ...
            _.each(this.cardsInPlay, function (card) {
                _this3.cards.push(card);
            });
            this.cardsInPlay = [];
        }
    }, {
...
var game = new _game.Game(["user", "comp"]);
var user = game.players["user"];
var comp = game.players["comp"];
var deck = game.deck;
...
var displayHand = function displayHand() {
    ...
    _.each(user.hand, function (card) {
...
var userDraw = function userDraw() {
...
var compDraw = function compDraw() {
    if (deck.cards.length > 0) {
...
var compMakePairs = function compMakePairs() {
    comp.makePairs();
...
var globCompChoice = void 0;
var compTurn = function compTurn() {
    var compChoice = _.sample(comp.hand);
...
var giveCard = function giveCard() {
